...
'''
x = encryption("helloworld!","password","1")
print(encryption("helloworld!","password","1"))
...
for i in data:
    a = encryption(i, "password","1")
    wf.write(a)

wf.close()
'''

a = encryption("helloworld!","password","1")
#for i in a:
    #print(hex(int(bin(ord(i))[2:].zfill(8),2))[2:].zfill(2),end=" ")
